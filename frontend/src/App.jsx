      ...
      <div style={{ background: '#fff', borderRadius: '16px', padding: '40px', width: '400px', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <p style={{ color: '#6b7280', margin: 0, fontSize: '14px' }}>
            ZK Health Credentials on Algorand
          </p>
        </div>
        ...
        <div style={{ marginTop: '20px', padding: '12px', background: '#f0fdf4', borderRadius: '8px', fontSize: '12px', color: '#166534', textAlign: 'center' }}>
          Your health data stays private. Only ZK proofs (pass/fail) are stored on Algorand.
        </div>
      </div>
    </div>
  );
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <span style={{
            ...
            {status ? 'TestNet' : 'Offline'}
          </span>
        </div>
        <div style={{ display: 'flex', gap: '2px', alignItems: 'center' }}>
          {navItems.map(item => (
            <Link key={item.path} to={item.path} style={{
              padding: '8px 16px', borderRadius: '8px', textDecoration: 'none', fontSize: '14px', fontWeight: '500',
        ...
        <div style={{ minHeight: '100vh', background: '#f9fafb' }}>
          ...
          <main style={{ maxWidth: '900px', margin: '0 auto', padding: user ? '24px' : '0' }}>
            <Routes>
              ...
              <Route path="/verify" element={<ProtectedRoute><VerifierDashboard /></ProtectedRoute>} />
